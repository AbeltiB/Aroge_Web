  ...
  useEffect(() => {
    ...
    async function finish() {
      ...
      if (params.get('intent') === 'user') {
        // Aroge Live: this link was generated by the seller for one claim
        // and shared to the buyer directly — nobody is polling this token
        // (see resolvePendingLogin), so this message is the buyer's only
        // confirmation that anything happened.
        if (callback.data && (callback.data as { claimId?: string | null }).claimId) {
          setMessage("You're confirmed! The seller will complete your order shortly — you can close this tab.")
        } else {
